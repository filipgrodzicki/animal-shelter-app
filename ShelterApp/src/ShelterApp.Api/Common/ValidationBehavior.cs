...
public sealed class ValidationResultBehavior<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
    where TRequest : IRequest<TResponse>
    where TResponse : Result
{
    ...
    private static TResponse CreateValidationResult(string errorMessage)
    {
